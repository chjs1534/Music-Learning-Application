...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="navbar">
      ...
      <button className="nav-button" onClick={() => handleNavigation('/my-students')}>
          <img src={"https://cdn-icons-png.flaticon.com/128/9316/9316744.png"} alt="Settings" className="nav-icon" />
