...
describe('Auth', () => {
  ...
  it('basic register and signin', async () => {
		...
		const preferred_username = 'testStudent';
    ...
    const user = await cognito.adminGetUser({
		...
		expect(body3.email).toEqual(email);
	...
	// MOBILE
  it('should add mobile user to mobile Cognito user pool and user database', async () => {
		const email = 'test@example.com';
		const preferred_username = 'testChild';
